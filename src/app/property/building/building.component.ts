...
export class BuildingComponent implements OnInit {
  ...
  location: SelectForm[] = [
    {value: 0.9, viewValue: 'Да'},
    {value: 1, viewValue: 'Нет'}
  ];

  fireAlarm: SelectForm[] = [
    {value: 0.9, viewValue: 'Да'},
    {value: 1, viewValue: 'Нет'}
  ];
  ...
  submit() {
    ...
    const alarmCoefficient = this.form.get('alarmControl').value;
    ...
    this.cost = +amountValue * 0.0005 * periodCoefficient * this.currencyCoefficient * otherCoefficient
      * cardCoefficient * creditCoefficient * locationCoefficient * alarmCoefficient;
  }
  ngOnInit(): void {
    this.form = new FormGroup({
      ...
      alarmControl: new FormControl('', Validators.required),
