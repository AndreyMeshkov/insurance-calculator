...
import {AbroadData, AbroadDataService} from '../../services/abroad-data.service';
...
export class AbroadComponent implements OnInit {
  ...
  countries: SelectForm[] = [
    ...
    {value: 2, viewValue: 'все страны мира, за исключением Индии, Индонезии, Таиланда, Израиля, США, Канады'},
