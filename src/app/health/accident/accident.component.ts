...
export class AccidentComponent implements OnInit {
  ...
  location: SelectForm[] = [
    ...
    {value: 2, viewValue: 'Все страны мира'}
  ];

  ageOfTheInsured: SelectForm[] = [
    {value: 0.5, viewValue: 'До 16 лет включительно'},
    {value: 1, viewValue: '17-65 лет'},
    {value: 2, viewValue: '66 лет и старше'}
  ];
  submit() {
    ...
    const sportCoefficient = this.form.get('sportControl').value;
    ...
    this.cost = +amountValue * 0.005 * this.periodCoefficient * this.currencyCoefficient * otherCoefficient
      * cardCoefficient * sportCoefficient * locationCoefficient * ageCoefficient;
  }
  ngOnInit(): void {
